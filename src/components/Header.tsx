        ...
        <div className="flex flex-wrap items-center justify-between bg-zinc-900 border border-zinc-800 rounded-xl p-4 shadow-xl gap-4">
          <div className="flex flex-wrap items-center gap-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-zinc-400 font-sans">Session Live</span>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <span className="text-lg font-mono text-emerald-400 font-black">+$1,420.50</span>
            </div>

            <div className="flex flex-col">
              <span className="text-[10px] text-zinc-500 uppercase font-mono font-bold">Hands / HR</span>
              <span className="text-lg font-mono text-zinc-100 font-black">842</span>
            </div>
          ...
          <div className="flex items-center gap-2">
            <div className="px-3 py-1.5 bg-zinc-800 rounded text-[10px] font-mono font-bold border border-zinc-700 text-zinc-300">
              6-MAX ZOOM
            </div>
